...
const content = {
  zh: { greeting: "你好", role: "现场工程师", choose: "选择今日项目", assigned: "个在建项目", selected: "已选择", status: "当前状态", idle: "尚未签到", idleHelp: "请选择项目，然后拍照签到。", checkIn: "拍照签到", checkedIn: "工作中", since: "签到时间", duration: "当前工时", checkOut: "拍照签退", locked: "工作期间项目已锁定", privacy: "不获取 GPS · 时间以服务器为准", logout: "退出", switchLanguage: "English", loadError: "无法加载当前工作状态，请刷新重试。", retry: "重试", noProjects: "暂无已分配的在建项目，请联系管理员。" },
  en: { greeting: "Hello", role: "Field Engineer", choose: "Choose today’s project", assigned: "active projects assigned", selected: "Selected", status: "Current status", idle: "Not checked in", idleHelp: "Choose a project, then take a selfie to check in.", checkIn: "Take selfie & check in", checkedIn: "Currently working", since: "Checked in", duration: "Current duration", checkOut: "Take selfie & check out", locked: "Project locked during this session", privacy: "No GPS · Official time comes from the server", logout: "Log out", switchLanguage: "中文", loadError: "We could not load your current work status. Try again.", retry: "Retry", noProjects: "No active projects are assigned. Contact your administrator." },
} as const;
