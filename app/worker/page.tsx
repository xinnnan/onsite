...
const content = {
  zh: { greeting: "你好", role: "现场工程师", choose: "选择今日项目", assigned: "个在建项目", selected: "已选择", status: "当前状态", idle: "尚未签到", idleHelp: "请选择项目，然后拍照签到。", checkIn: "拍照签到", checkedIn: "工作中", since: "签到时间", duration: "当前工时", checkOut: "拍照签退", locked: "工作期间项目已锁定", privacy: "时间以服务器为准", logout: "退出", changePassword: "修改密码", switchLanguage: "English", loading: "正在加载…", loadError: "无法加载当前工作状态，请刷新重试。", retry: "重试", noProjects: "暂无已分配的在建项目，请联系管理员。" },
  en: { greeting: "Hello", role: "Field Engineer", choose: "Choose today’s project", assigned: "active projects assigned", selected: "Selected", status: "Current status", idle: "Not checked in", idleHelp: "Choose a project, then take a selfie to check in.", checkIn: "Take selfie & check in", checkedIn: "Currently working", since: "Checked in", duration: "Current duration", checkOut: "Take selfie & check out", locked: "Project locked during this session", privacy: "Official time comes from the server", logout: "Log out", changePassword: "Change password", switchLanguage: "Español", loading: "Loading…", loadError: "We could not load your current work status. Try again.", retry: "Retry", noProjects: "No active projects are assigned. Contact your administrator." },
  es: { greeting: "Hola", role: "Ingeniero de campo", choose: "Elige el proyecto de hoy", assigned: "proyectos activos asignados", selected: "Seleccionado", status: "Estado actual", idle: "Sin registrar entrada", idleHelp: "Elige un proyecto y toma una foto para registrar la entrada.", checkIn: "Foto y entrada", checkedIn: "Trabajando", since: "Entrada registrada", duration: "Duración actual", checkOut: "Foto y salida", locked: "El proyecto queda bloqueado durante esta sesión", privacy: "La hora oficial proviene del servidor", logout: "Cerrar sesión", changePassword: "Cambiar contraseña", switchLanguage: "한국어", loading: "Cargando…", loadError: "No pudimos cargar el estado de trabajo. Inténtalo de nuevo.", retry: "Reintentar", noProjects: "No tienes proyectos activos asignados. Contacta al administrador." },
  ko: { greeting: "안녕하세요", role: "현장 엔지니어", choose: "오늘의 프로젝트 선택", assigned: "개의 활성 프로젝트가 배정됨", selected: "선택됨", status: "현재 상태", idle: "출근 전", idleHelp: "프로젝트를 선택한 후 셀카를 촬영해 출근을 기록하세요.", checkIn: "사진 촬영 및 출근", checkedIn: "근무 중", since: "출근 시간", duration: "현재 근무 시간", checkOut: "사진 촬영 및 퇴근", locked: "근무 중에는 프로젝트가 고정됩니다", privacy: "공식 시간은 서버 시간을 기준으로 합니다", logout: "로그아웃", changePassword: "비밀번호 변경", switchLanguage: "中文", loading: "불러오는 중…", loadError: "현재 근무 상태를 불러오지 못했습니다. 다시 시도하세요.", retry: "다시 시도", noProjects: "배정된 활성 프로젝트가 없습니다. 관리자에게 문의하세요." },
} as const;
...
function WorkerDashboard() {
  ...
  const now = new Date();
  const dateText = new Intl.DateTimeFormat(intlLocales[locale], { weekday: "long", year: "numeric", month: "long", day: "numeric" }).format(now);
